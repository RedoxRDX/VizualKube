...
#define MyAppAssocExt ".VISUALKUBE"
#define MyAppAssocKey StringChange(MyAppAssocName, " ", "") + MyAppAssocExt

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{D6F64D44-317A-4792-B13F-49FFF388CBD9}
AppName={#MyAppName}
...
OutputDir=D:\Dev\VizualKube\BUILDFORSETUP\Installer
OutputBaseFilename=VKUBE
SetupIconFile=D:\Dev\VizualKube\VKUBE.ico
...
Source: "D:\Dev\VizualKube\WFSharp\bin\Release\net10.0-windows\WFSharp.deps.json"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\Dev\VizualKube\WFSharp\bin\Release\net10.0-windows\WFSharp.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\Dev\VizualKube\WFSharp\bin\Release\net10.0-windows\WFSharp.exe"; DestDir: "{app}"; Flags: ignoreversion
